...
QB_WA_PRODUCT_UTILITIES = "Utilities Reimbursement"
QB_WA_PRODUCT_WOODWORKING = "Woodworking Supplies Reimbursement"
QB_WA_PRODUCT_FILAMENT = "3D Printing Reimbursement"
QB_WA_PRODUCT_MATERIALS = "Project Material Reimbursement"
QB_WA_PRODUCT_WELDING = "Welding Supplies Reimbursement"
QB_WA_PRODUCT_OTHER = "Other Reimbursement"
...
QB_WA_CLASS_UTILITIES = "Maker Space"
QB_WA_CLASS_WOODWORKING = "Maker Space"
QB_WA_CLASS_FILAMENT = "Maker Space"
QB_WA_CLASS_MATERIALS = "Maker Space"
QB_WA_CLASS_WELDING = "Maker Space"
QB_WA_CLASS_OTHER = "Maker Space"
...
def parse_invoice (i_type, i_info, dest, amount):
    ...
    if i_type == "MembershipApplication" or i_type == "MembershipRenewal":
        ...
        elif i_info.find("Utilities") != -1:
            i_product = QB_WA_PRODUCT_UTILITIES
            i_class = QB_WA_CLASS_UTILITIES
        elif i_info.find("Woodworking") != -1:
            i_product = QB_WA_PRODUCT_WOODWORKING
            i_class = QB_WA_CLASS_WOODWORKING
        elif i_info.find("3D") != -1:
            i_product = QB_WA_PRODUCT_FILAMENT
            i_class = QB_WA_CLASS_FILAMENT
        elif i_info.find("Welding") != -1:
            i_product = QB_WA_PRODUCT_WELDING
            i_class = QB_WA_CLASS_WELDING
        elif i_info.find("Project") != -1:
            i_product = QB_WA_PRODUCT_MATERIALS
            i_class = QB_WA_CLASS_MATERIALS
        elif i_info.find("Other") != -1:
            i_product = QB_WA_PRODUCT_OTHER
            i_class = QB_WA_CLASS_OTHER
        else:
